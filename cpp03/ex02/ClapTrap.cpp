...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2023/10/17 19:14:53 by mel-gand          #+#    #+#             */
/*   Updated: 2023/11/06 00:08:06 by mel-gand         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
    std::cout << "Parametrique ClapTrap constructor called" << std::endl;
    this->name = name;
    this->Hit_points = 10;
    this->Energy_points = 10;
    this->Attack_Damage = 0;
...
{
    if (this->Energy_points <= 0 && (this->Hit_points > 0 && this->Hit_points < 100))
    {
